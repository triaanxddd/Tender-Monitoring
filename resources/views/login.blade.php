...
<body class="">
  <div class="container position-sticky z-index-sticky top-0">
    <div class="row">
      <div class="col-12">
        <!-- Navbar -->
        <nav class="navbar navbar-expand-lg bg-gradient-primary blur border-radius-lg top-0 z-index-3 shadow position-absolute mt-4 py-2 start-0 end-0 mx-4">
          <div class="container-fluid d-flex justify-content-center">
            <a class="navbar-brand font-weight-bolder ms-lg-0 ms-3 text-white" href="{{ asset('dashboard-template') }}//pages/dashboard.html" style="font-size:medium">
              Energia Kegiatan Pelelangan
            </a>
  ...
  <main class="main-content  mt-0">
    <section>
      <div class="page-header min-vh-100">
        <div class="container">
          <div class="row">
            <div class="col d-flex flex-column mx-lg-0 mx-auto">
                <img src="../logo/logo-new.png" alt="">
            </div>
              ...
              <div class="card card-plain">
                ...
                <div class="card-body">
                  <form role="form" action="{{ route('authenticate') }}" method="post">
                    @csrf
                    <div class="mb-3">
                      <input type="email" name="email" class="form-control form-control-lg"  @if(isset($_COOKIE["email"])) value="{{ $_COOKIE['email'] }}" @endif  placeholder="Email" aria-label="Email">
                      @error('email')
                        <span style="color:red;">{{ $message }}</span>
                      @enderror
                    </div>
                    <div class="mb-3">
                      <input type="password" name="password" class="form-control form-control-lg"  @if(isset($_COOKIE["password"])) value="{{ $_COOKIE['password'] }}" @endif placeholder="Password" aria-label="Password">
                      @error('password')
                        <span style="color:red;">{{ $message }}</span>
                      @enderror
                    </div>
                    <div class="form-check form-switch">
                      <input class="form-check-input" name="remember" type="checkbox" id="rememberMe" @if(isset($_COOKIE["email"])) checked @endif >
            ...
            <!-- <div class="col-6 d-lg-flex d-none h-100 my-auto pe-0 position-absolute top-0 end-0 text-center justify-content-center flex-column">
              <div class="position-relative bg-gradient-primary h-100 m-3 px-7 border-radius-lg d-flex flex-column justify-content-center overflow-hidden" style="background-image: url('../logo/logo-new.png');
